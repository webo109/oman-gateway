...
export const Route = createFileRoute("/power")({
  head: () =>
    pageSeo({
      ...
      description:
        "Utility-scale Solar PV, BESS, and HV Grid infrastructure: the active division of Centric for Business Solutions.",
      ogDescription:
          ...
          <div className="relative max-w-7xl mx-auto">
            ...
            <h1 className="reveal reveal-delay-1 mt-6 text-5xl sm:text-7xl font-extralight tracking-[-0.02em] leading-[1.02] max-w-4xl">
              {lang === "ar" ? (
                ...
                <>
                  Power &amp; <span className="font-serif italic text-brand-teal">renewable</span>{" "}
                  energy.
                </>
              )}
            </h1>
              ...
              <div className="relative max-w-7xl mx-auto grid grid-cols-12 gap-8 items-center">
                ...
                >
                  <div className="group relative overflow-hidden rounded-2xl border border-brand-line tilt-card isolate">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-tr from-background/70 via-background/10 to-transparent pointer-events-none" />
